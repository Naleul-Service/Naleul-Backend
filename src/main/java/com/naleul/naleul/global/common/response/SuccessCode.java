...
public enum SuccessCode {
    ...
    RETROSPECTIVE_FOUND(HttpStatus.OK, "회고 조회 성공"),
    RETROSPECTIVES_FOUND(HttpStatus.OK, "회고 전체 조회 성공"),
    RETROSPECTIVE_UPDATED(HttpStatus.OK, "회고 수정 성공"),
    RETROSPECTIVE_DELETED(HttpStatus.OK, "회고 삭제 성공"),
